  ...
  return (site: Site) => {
    site.process([".html"], async (page) => {
      ...
      if (options.reset !== false) {
        ...
        // style.innerText = await import(`npm:@unocss/reset@0.53.5/${options.reset}.css`, { assert: { type: "css" } })
